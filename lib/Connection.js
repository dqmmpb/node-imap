...
Connection.prototype._processQueue = function() {
  ...
  try {
    ...
    this.debug && this.debug('_processQueue write error: ' + e.stack);
  }
...
Connection.prototype._sockWriteAppendData = function(appendData)
{
  ...
  try {
    ...
    this.debug && this.debug('_sockWriteAppendData write error: ' + e.stack);
  }
};
  ...
  if (!this._curReq
    ...
    if (this._idle.started > 0) {
      ...
      try {
        ...
        this.debug && this.debug('_enqueue write error: ' + e.stack);
      }
    }
  }
};
